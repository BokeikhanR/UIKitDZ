...
class IPhoneVC: UIViewController, UIPickerViewDelegate {
    
//
//    func passData(){
//        let storyboard = UIStoryboard(name: "Main", bundle: nil)
//        guard let korzinaVC = storyboard.instantiateViewController(identifier: "KorzinaVC") as? KorzinaVC else {return}
//        korzinaVC.name = "Ruslan"
//        show(korzinaVC, sender: nil)
//    }
    ...
    var menuArray = ["1", "2", "3"]
    var imageArray = [UIImage(named: "IPhone1"),
...
extension IPhoneVC: UIPickerViewDataSource, UIPrinterPickerControllerDelegate{
